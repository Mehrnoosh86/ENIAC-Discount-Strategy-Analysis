...
1. Concentrate promotions around key dates
...
2. Avoid aggressive discounts on high-revenue categories such as iMac and iPhone. These products perform well with lower discounts, allowing the company to preserve margins.

3. Improve data collection and pipeline reliability
